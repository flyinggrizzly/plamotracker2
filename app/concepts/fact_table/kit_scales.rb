module FactTable
  module KitScales
    ...
    DATA = [
      ...
      { name: "1/10",           nickname: nil,      denominator: 10 },
      { name: "1/12",           nickname: nil,      denominator: 12 },
      ...
      { name: "1/200",          nickname: nil,      denominator: 200 },
      ...
      { name: "Heroic",         nickname: "heroic", denominator: nil },
      { name: "75mm",           nickname: nil,      denominator: nil },
    ]
