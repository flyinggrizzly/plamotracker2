module FactTable
  module KitLines
    ...
    DATA = [
      ...
      { name: "Volks Injection Molding System IMS", nickname: "IMS",               slug: "ims",             producer_name: "Volks"},
      ...
      { name: "Minimum Factory",                    nickname: "Minimum Factory",   slug: "minimum_factory", producer_name: "MAX Factory" },
      ...
      { name: "Super Spirits Series",               nickname: "SSS",               slug: "sss",             producer_name: "Volks" },
      { name: "High-Spec Garage Kit",               nickname: "HSGK",              slug: "hsgk",            producer_name: "Volks" },
      { name: "FSS Figure Collection",              nickname: "fss-fc",            slug: "fss-fc",          producer_name: "Volks" },
      { name: "Profipack",                          nickname: "profipack",         slug: "profipack",       producer_name: "Eduard" },
      { name: "Echoes of Camelot",                  nickname: "echoes of camelot", slug: "echoes_camelot",  producer_name: "Big Child Creatives" },
      { name: "Songs of War",                       nickname: "songs of war",      slug: "songs_war",       producer_name: "Big Child Creatives" },
    ].freeze
